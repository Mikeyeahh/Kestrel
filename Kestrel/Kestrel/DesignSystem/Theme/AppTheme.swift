...
struct AppTheme {
    ...
    private static let midnight = AppTheme(
        accent:              Color(red: 0.357, green: 0.612, blue: 1),       // #5B9CFF
    ...
    private static let amberTheme = AppTheme(
        accent:              Color(red: 1, green: 0.722, blue: 0),           // #FFB800
        accentDim:           Color(red: 1, green: 0.722, blue: 0).opacity(0.15),
        background:          Color(red: 0.051, green: 0.039, blue: 0),       // #0D0A00
        backgroundCard:      Color.white.opacity(0.04),
        ...
        amber:               Color(red: 1, green: 0.584, blue: 0),           // #FF9500 — slightly different for contrast
        red:                 Color(red: 1, green: 0.231, blue: 0.361),
        blue:                Color(red: 0, green: 0.784, blue: 1),
        textPrimary:         Color.white,
        textMuted:           Color.white.opacity(0.7),
    ...
    private static let dracula = AppTheme(
        ...
        background:          Color(red: 0.157, green: 0.165, blue: 0.212),   // #282A36
        ...
        amber:               Color(red: 1, green: 0.722, blue: 0),
        red:                 Color(red: 1, green: 0.333, blue: 0.333),       // #FF5555 Dracula red
        blue:                Color(red: 0.514, green: 0.831, blue: 0.976),   // #83D4F9
        textPrimary:         Color(red: 0.973, green: 0.973, blue: 0.949),   // #F8F8F2
    ...
    private static let arctic = AppTheme(
        accent:              Color(red: 0, green: 0.831, blue: 1),           // #00D4FF
        accentDim:           Color(red: 0, green: 0.831, blue: 1).opacity(0.15),
        background:          Color(red: 0.039, green: 0.086, blue: 0.157),   // #0A1628
        backgroundCard:      Color.white.opacity(0.04),
